...
<section class="content">
    <div class="body_scroll">
        <div class="block-header"><div class="row"><div class="col-lg-7 col-md-6 col-sm-12"><h2>Consume/Issue Stock</h2></div></div></div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                        <?php  // Code Here/////  ?>
                    <form class="form-horizontal style-form" method="get" action="consumestock.php">
              <table width="100%">
        ...
        $resl1="SELECT * FROM `brands` where `bid`='$bbid';";
            ...
            ?>
                                  ...
                                  <td class="numeric" data-title="Stock ID:"><?php echo $pre['stid']; ?></td>
                                      ...
                                      <td class="numeric" data-title="Quantity:"><?php echo $pre['remain']." ".$pre['measures']; ?></td>
                                      <td class="numeric" data-title="Action:"> 
                                     <?php if($pre['stock_status']=="instock"){ ?><a href="consume.php?stid=<?php echo $pre['stid'];?>"><input type="button" value= "Issue Now"></a><?php } ?>
                                      </td>
