...
foreach($_POST as $k=>$v)
	...
	$qi3="SELECT * FROM `stock_headers` where `shid`='$shid';"; 
					$rr3=mysqli_query($con,$qi3);
					  ...
					  while($loop<$quantity)
					  {
					  $addq=" INSERT INTO `stock_assets` (`asset_id`, `header_id`, `item_name`, `header`, `status`, `measures`, `stock_type`, `quality`, `color`, `count`, `barcode`, `pic`, `added_on`, `add_date`, `add_month`, `add_year`, `added_by`, `rate`, `vendor`, `discontinue_date`, `dis_date`, `dis_month`, `dis_year`, `discontinued_by`, `stock_status`, `room`,`brand`) VALUES 
					  (NULL, '$shid', '$itemname', '$header', 'active', '$measures', '$stocktype', '$quality', '$color', '1', '$barcode', '$tgt', '$added_on', '$add_date', '$add_month', '$add_year', '$usr', '$rate', '$vendor', '', '', '', '', '', 'free','$room','$brand');";
...
<!-- Jquery Core Js --> 
<script src="<?php echo $site; ?>assets/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js --> 
<script src="<?php echo $site; ?>assets/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js --> 

<script src="<?php echo $site; ?>assets/bundles/mainscripts.bundle.js"></script>
</body>
</html>