...
<section class="content">
    <div class="body_scroll">
        <div class="block-header"><div class="row"><div class="col-lg-7 col-md-6 col-sm-12"><h2>Reprint Checkout</h2></div></div></div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
						<?php  // Code Here/////  ?>
							  <form class="form-horizontal style-form" method="get" action="printafter.php">
          	<!-- BASIC FORM ELELEMNTS -->
			<table style="background-color:#002;color:#fff;" width="100%">
				<tr><td>Booking ID:</td><td> <input type="text" name="booking"  class="form-control"></td>
				 ...
				 <td><input type="submit" name="searchuser" Value="Search" class="btn btn-round btn-default"/></td>
                      ...
                      <div class="content-panel">
						  <h4><i class="fa fa-angle-right"></i> Checkout For Attendent</h4>
						  ...
						  <?php 
$qr="select * from `visits` where `checkout_date` IS NOT NULL and `fnwo` != 'Extra Donation' order by `rcpt` DESC limit 15;"; 
		...
		while ($rt=mysqli_fetch_array($rr))
		{
			?>
                                  ...
                                  <tr>
                                      ...
                                      <td data-title="Action:"><a href="printafter.php?booking=<?php echo $rt['bookingid'];?>"><input type="button" value ="Reprint Now"></a></td>
                                  </tr>
