...
<section class="content">
    <div class="body_scroll">
		...
		<?php
if(isset($_GET['ssid']) || $_GET['type']=="pass2")
{
...
{
		if($_GET['type']=="application"||$_GET['type']=="all"||$_GET['type']=="withoutpass")	
		{ ?>	
...
<tr><td >Attendant Sign:<br>.....................</td><td style="text-align:right;">Manager:<br>.....................</td><td style="text-align:right;">FrontDesk/Cashier:<br><?php echo $_SESSION['usr']; ?></td></tr>
		...
		<?php } if($_GET['type']=="pass"||$_GET['type']=="all") { ?>
...
<tr><td colspan="3"><center>Valid For 4 Days Only.</center></td ></tr>
			...
			<?php  }?>
				...
				<div>
		<?php  } if($_GET['type']=="security"||$_GET['type']=="all"||$_GET['type']=="withoutpass") {?>
...
<table border="0" cellpadding="0" cellspacing="0" width="600" >
	<tbody>
		...
		<tr height="20" class="rw">
			...
			<td colspan="4" class="baseb" style="text-transform:capitalize;"><?php if(isset($_GET['samount'])){ $number=$_GET['samount']; } else { $number=$rs['advance']; } include("inc/indiancurrency.php");?></td>
		</tr>
		<tr height="20" class="rw">
		...
		<tr height="20" class="rw">
			...
			<td colspan="2" class="baseb" ><?php if(isset($_GET['samount'])){ echo $_GET['samount'];} else { echo $rs['advance']; } ?></td>
