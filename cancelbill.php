...
<section class="content">
    <div class="body_scroll">
        <div class="block-header"><div class="row"><div class="col-lg-7 col-md-6 col-sm-12"><h2>List All Cancel Bills</h2></div></div></div>
  ...
  $qr="SELECT * from `cash` where `name` like '%cancel%' and `reciptno`<>'0';";
...
<td data-title="Date"><?php echo date('d/m/Y',$rt['handovertime']); ?></td>
	<td data-title="Slip No:"><?php echo $rt['reciptno']; ?></td>
