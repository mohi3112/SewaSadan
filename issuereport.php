...
<section class="content">
    <div class="body_scroll">
        <div class="block-header"><div class="row"><div class="col-lg-7 col-md-6 col-sm-12"><h2>Bedding Issue Report</h2></div></div></div>
                ...
                <div class="col-lg-12">
                    <div class="card">
						...
						<table width="100%" cellspacing="6px" style="padding-top:100px;background-color:#ccc;" align="center" width="100%" bgcolor="#ccc">
						  <form method="get" action="issuereport.php">
...
if(isset($_GET['chk']))
{
	...
	$st=strtotime($start);
	$en=strtotime($end);
 $qr="SELECT * FROM  `stock_asset_allocation`   WHERE `issue_date` BETWEEN '$st' AND '$en' ;";


	?><section id="no-more-tables"><div id="printableArea" style="width:100%;height:90%;">
	
                              <table class="table table-bordered table-striped table-condensed cf" style="font-size:12px;">
                                  <thead class="cf">
...
<tr>
	...
	<td data-title="Date:"><?php $id=$rt['issue_date']; echo date('d-m-Y', $id)?></td>
	...
	<td data-title="Bed:"><?php echo $rt['bed']; ?></td>
		<td data-title="Bed:"><?php echo $rt['item_name']; ?></td>
	<td data-title="Time:"><?php $idt=$rt['issue_date']; echo date('h:i a', $idt)?></td>
