...
<section class="content">
    <div class="body_scroll">
        <div class="block-header"><div class="row"><div class="col-lg-7 col-md-6 col-sm-12"><h2>Checkout</h2></div></div></div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
					  ...
					  <form class="form-horizontal style-form" method="get" action="checkoutbackend.php">
		...
		while ($rt=mysqli_fetch_array($rr))
		{
			?>
                                  ...
                                  <tr>
                                      ...
                                      <td data-title="Action:"><a href="checkoutbackend.php?booking=<?php echo $rt['bookingid'];?>"><input type="button" value ="Checkout Now"></a></td>
                                  </tr>
